					...
					<div class="xg-12 g-12 m-12 p-12 s-12">
						<div class="sm">
							...
							<div class="xg-4 g-4 m-6 p-6 s-10">
								...
								<p class="h5 font-weight-normal text-white tm_center">Você acertou poucas questões. Procure melhorar sua alimentação e beber mais água!</p>
								<div class="pc5"></div>
								...
								<div class="sm">
									...
									<ul id="social" class="sm">
										<li class="xg-2 g-2 m-3 p-3 s-3">
											<a href="https://www.facebook.com/sharer.php?u=https://www.aguamineraltrezetilias.com.br/quiz/&t=Eu acertei poucas questões sobre a Água, e você, quantas acerta?">
												<img src="img/fb.svg" class="img-questions">
												<img src="img/sombra.svg" class="sombra_social">
											</a>
										</li>
										<li class="xg-2 g-2 m-3 p-3 s-3">
											<a href="https://twitter.com/intent/tweet?via=aguamineraltrezetilias&text=Eu acertei poucas questões sobre a a água e você, quantas acerta?&url=https://aguamineraltrezetilias.com.br/quiz/
">
