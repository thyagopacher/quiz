            ...
            <div class="xg-12 g-12 m-6 p-12 s-12">
                <div class="sm">
                    ...
                    <div class="xg-4 g-4 m-6 p-6 s-10">
                        ...
                        <p class="h5 font-weight-normal text-white tm_center">Você acertou todas das questões! Continue mantendo seus hábitos saudáveis.</p>
                        <div class="pc5"></div>
                    ...
                    <div class="s-1 m"></div>
                    <div class="s-2 m"></div>
                    <div class="xg-4 g-4 m-6 p-6 s-7 tm_center">
                        <div class="pc2"></div>
                        <img src="fatias/sucesso.png" class="img-questions" >
                    </div>
                    <div class="s-2 m"></div>
                        ...
                        <div class="sm">
                            ...
                            <ul id="social" class="sm">
                                <li class="xg-2 g-2 m-3 p-3 s-3">
                                    <a href="https://www.facebook.com/sharer.php?u=https://www.aguamineraltrezetilias.com.br/quiz/&t=Eu acertei todas as questões sobre a Água, e você, quantas acerta?">
                                        <img src="img/fb.svg" class="img-questions">
                                            <img src="img/sombra.svg" class="sombra_social">
                                                </a>
                                                </li>
                                                <li class="xg-2 g-2 m-3 p-3 s-3">
                                                    <a href="https://twitter.com/intent/tweet?via=aguamineraltrezetilias&text=Eu acertei todas as questões sobre a a água e você, quantas acerta?&url=https://aguamineraltrezetilias.com.br/quiz/
                                                       ">
                                                                                    ...
                                                                                    <a href="https://www.linkedin.com/cws/share?token&isFramed=false&url=https://aguamineraltrezetilias.com.br/quiz/">
                                                                                        <img src="img/gp.svg" class="img-questions">
                                                                                            <img src="img/sombra.svg" class="sombra_social">
                                                                                                ...
                                                                                                <ul id="links">
                                                                                                    <li><a href="https://aguamineraltrezetilias.com.br/vida-saudavel/3-deliciosas-receitas-de-agua-saborizada-para-fazer-um-detox-no-seu-corpo/">3 deliciosas receitas de água saborizada para fazer um detox no seu corpo!</a></li>
                                                                                                    <li><a href="https://aguamineraltrezetilias.com.br/vida-saudavel/5-cuidados-para-se-manter-saudavel-neste-verao/">5 cuidados para se manter saudável neste verão</a></li>
                                                                                                    <li><a href="https://aguamineraltrezetilias.com.br/vida-saudavel/a-hidratacao-conforme-a-faixa-etaria-das-pessoas/">A hidratação conforme a faixa etária das pessoas</a></li>
                                                                                                </ul>
                                                                                                </div>
                                                                                                </div>
                                                                                                </div>
